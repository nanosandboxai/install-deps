...
function Install-NanosandboxDeps {
    ...
    # --- Download & install libkrunfw.dll ---
    Write-Header "Installing libkrunfw.dll (kernel firmware)"
    ...
    try {
        ...
        Write-Info "You may need to place libkrunfw.dll manually in: $targetDir"
    } finally {
